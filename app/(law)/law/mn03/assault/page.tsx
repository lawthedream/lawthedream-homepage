...
export const metadata: Metadata = {
  title: '성폭행 | 더드림교통형사센터',
  description: '성폭행 사건 전문 변호사. 02-6959-5053.',
  keywords: '성폭행,강간,성범죄변호사',
...
export default function Page() {
  return (
    <>
      <SiteSubVisual title="성폭행" site="law" bgImage="/law/mn03/img/sub_vs03.jpg" />
      <LawNavTabs current="/law/mn03/assault" />
      <div id="contents">
        <div className="cntbox wd2000" style={{ paddingTop: 60, paddingBottom: 80 }}>
          <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
        <li style={{ marginTop: 0 }}>
          <img src="/law/mn03/img/mn03_03_img1.jpg" alt="" style={{ display: 'block', width: '100%', height: 'auto' }} />
        </li>
